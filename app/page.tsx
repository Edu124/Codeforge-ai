...
export default function Home() {
  ...
  const handleDownload = () => {
    window.location.href = 'https://github.com/Edu124/Codeforge-ai/releases/download/v0.3.3/Codeforge.AI_0.3.3_x64_en-US.msi'
  }
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-slate-500">
                ...
                <li><a href="https://github.com/Edu124/Codeforge-ai/releases/download/v0.3.3/Codeforge.AI_0.3.3_x64_en-US.msi" target="_blank" rel="noreferrer" className="hover:text-cyan-400 transition-colors">GitHub</a></li>
              </ul>
            </div>
            <div>
